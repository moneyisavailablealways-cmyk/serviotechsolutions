...
const Process = () => {
  const steps = [
    { icon: Lightbulb, title: "Discovery", description: "We understand your business needs and project goals" },
    { icon: Calendar, title: "Planning", description: "Strategic roadmap and timeline development" },
    { icon: Code, title: "Development", description: "Agile development with continuous integration" },
    { icon: TestTube, title: "Testing", description: "Comprehensive quality assurance and testing" },
    { icon: Rocket, title: "Deployment", description: "Smooth launch and production deployment" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {steps.map((step, index) => (
            <Card key={index} className="relative hover:shadow-xl transition-all duration-300 border-2 border-primary/60 hover:border-primary">
